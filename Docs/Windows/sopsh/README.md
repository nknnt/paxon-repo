...
Sopsh is a Windows-only shell environment designed for streamlined command execution and development workflows.

When installed via paxon, it is automatically placed in `/commands`
